...
% Tinklo strukturos parinkimas (pasirinkti 5 neuronai)
...
for i = 1:100000
for n = 1:length(x)
% pasleptojo sluoksnio neuronams
v1_1 = x(n)*w11_1 + b1_1;
v2_1 = x(n)*w21_1 + b2_1;
v3_1 = x(n)*w31_1 + b3_1;
v4_1 = x(n)*w41_1 + b4_1;
v5_1 = x(n)*w51_1 + b5_1;
% aktyvavimo funkcija (sigmoidine)
y1_1 = 1/(1+exp(-v1_1));
y2_1 = 1/(1+exp(-v2_1));
y3_1 = 1/(1+exp(-v3_1));
y4_1 = 1/(1+exp(-v4_1));
y5_1 = 1/(1+exp(-v5_1));
% isejimo sluoksnio neuronui
v1_2 = y1_1*w11_2 + y2_1*w12_2 + y3_1*w13_2 + y4_1*w14_2 + y5_1*w15_2 + b1_2;
% atsakas (tiesine aktyvavimo funkcija)
y = v1_2;
...
delta1_2 = e;
% klaidos gradientas paslepto sluoksnio neuronams
...
% isejimo sluoksnio neuronui
v1_2 = y1_1*w11_2 + y2_1*w12_2 + y3_1*w13_2 + y4_1*w14_2 + y5_1*w15_2 + b1_2;
% aktyvavimo funkcija (tiesine aktyvavimo funkcija)
y = v1_2;
Y(n) = y;
end
plot(x, Y, 'b+')
